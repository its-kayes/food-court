...
export const CartList = () => {
    ...
    let { data, isLoading, refetch } = useQuery("orders", () =>
        fetch(`https://food-court-d87gj4rlj-its-kayes.vercel.app/api/orders?email=${user.email}`).then((res) => res.json())
    );
    // let { data, isLoading, refetch } = useQuery("orders", () =>
    //     fetch(`https://food-court-d87gj4rlj-its-kayes.vercel.app/api/orders?email=${emailx}`).then((res) => res.json())
    // );
